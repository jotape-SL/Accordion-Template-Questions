...
Um FAQ feito utilizando o template de acordeão. Feito como treino de React.
...
$ git clone https://github.com/jotape-SL/Accordion-Template-Questions.git

# Abra o terminal e entre na pasta
$ cd ./Accordion-Template-Questions.git
...
- **[FAQ](https://accordion-template-questions.vercel.app/)**
...
Este projeto está sob a licença MIT - veja o arquivo [LICENSE.md](https://github.com/jotape-SL/Accordion-Template-Questions/blob/main/LICENSE) para detalhes.
